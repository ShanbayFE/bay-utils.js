...
const test = (func, dataArr) => {
    it('should return correct result', () => {
        dataArr.forEach((data, index) => {
            ...
            assert.equal(
                bayUtils[func](params[0], params[1], params[2]),
                result,
                `error: ${index}`,
            );
        });
...
describe('format', () => {
    ...
    describe('formatSafetyStr', () => {
        describe('should return replaced string by symbol', () => {
            ...
            it('should return 1------------1 because symbolLen is larger than string lenght', () => {
                assert.deepEqual(
                    bayUtils.formatSafetyStr('123454321', 1, 1, '-', 12),
                    '1------------1',
                );
            });
            it('should return 1-------1 because symbolLen is undefined', () => {
                assert.deepEqual(
                    bayUtils.formatSafetyStr('123454321', 1, 1, '-', undefined),
                    '1-------1',
                );
            });
            it('should return 1-------1 because symbolLen is null', () => {
                assert.deepEqual(
                    bayUtils.formatSafetyStr('123454321', 1, 1, '-', null),
                    '1-------1',
                );
            });
            it('should return 1-------1 because symbolLen is not number', () => {
                assert.deepEqual(
                    bayUtils.formatSafetyStr('123454321', 1, 1, '-', 'e'),
                    '1-------1',
                );
            });
        });
    ...
    describe('formatSafetyEmail', () => {
        it('should return replaced email by symbol', () => {
            ...
            assert.equal(
                bayUtils.formatSafetyEmail('1231231231@qq.com', 2, 5),
                '12**********q.com',
            );
        });
    });
