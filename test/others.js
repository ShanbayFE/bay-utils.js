...
describe('others', () => {
    describe('getSearchValue', () => {
        it('get url search value by name', () => {
            const value = xbayCommon.getSearchValue('status', 'https://news.admin.shanbay.com/admin/articles/?status=2');
    ...
    describe('getCookie', () => {
        it('get cookie by name', () => {
            ...
            assert.equal(xbayCommon.getCookie(cookie, 'csrftoken'), 'HSBe1Zo6zOUTbM30rGZHWwxXsmcT577S');
        });
    });
});
