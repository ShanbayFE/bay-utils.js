...
describe('others', () => {
    describe('getSearchValue', () => {
        it('get url search value by name', () => {
            const value = bayUtils.getSearchValue(
                'status',
                'https://news.admin.shanbay.com/admin/articles/?status=2',
            );
    ...
    describe('getCookie', () => {
        it('get cookie by name', () => {
            const cookie =
                'locale=zh-cn; userid=23624; csrftoken=HSBe1Zo6zOUTbM30rGZHWwxXsmcT577S; undefined,userid=23624; userid=23624';
            assert.equal(
                bayUtils.getCookie(cookie, 'csrftoken'),
                'HSBe1Zo6zOUTbM30rGZHWwxXsmcT577S',
            );
        });
    });
    ...
    describe('getUrlsFromString', () => {
        ...
        it('get urls from string', () => {
            const string =
                'https://www.google.com/q/qwe/a i like google, I like stackoverflow too. https://stackoverflow.com/qwe?qwe=ee';
            const urls = bayUtils.getUrlsFromStr(string);
        ...
        it('get same urls from string', () => {
            const string =
                'https://www.google.com/q/qwe/a I like google, I like stackoverflow too. https://www.google.com/q/qwe/a';
            const urls = bayUtils.getUrlsFromStr(string);
    ...
    describe('transformUrlToAnchors', () => {
        it('transform urls to anchors', () => {
            const string =
                'I like google, https://www.google.com; I like stackoverflow too. https://stackoverflow.com/';
            const newString = bayUtils.transformUrlToAnchor(string);
            assert.equal(
                newString,
                "I like google, <a href='https://www.google.com' target='_blank'>https://www.google.com</a>; I like stackoverflow too. <a href='https://stackoverflow.com/' target='_blank'>https://stackoverflow.com/</a>",
            );
        });
        it('transform same urls to anchors', () => {
            const string =
                'https://www.google.com i like google, https://www.google.com, I like stackoverflow too. https://stackoverflow.com/';
            const newString = bayUtils.transformUrlToAnchor(string);
            assert.equal(
                newString,
                "<a href='https://www.google.com' target='_blank'>https://www.google.com</a> i like google, <a href='https://www.google.com' target='_blank'>https://www.google.com</a>, I like stackoverflow too. <a href='https://stackoverflow.com/' target='_blank'>https://stackoverflow.com/</a>",
            );
        });
    });
    ...
    describe('getAppNameFromAgent', () => {
        it('get app name from agent', () => {
            ...
            const agent1 =
                'this is hahaha com.shanbay.reader/7.5.900 (Android,4.4.4,MI 3W,Xiaomi; Frontend/1.1)';
